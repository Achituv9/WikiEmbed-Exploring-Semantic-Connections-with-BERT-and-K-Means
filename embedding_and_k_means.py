        ...
        with open(file_path, 'r', encoding='utf-8') as file:
            ...
            for article in data:
                ...
                if total_articles % 25000 == 0:
                    ...
                    print(f"Processed {total_articles} articles so far... Saving partial NPZ...")
...
# Save the merged file in the main folder
...
for i in range(1, 26):
    ...
    # Perform KMeans clustering with PyTorch
    ...
    # Convert cluster IDs to numpy array (CPU)
    cluster_labels = cluster_ids_x.cpu().numpy()
    
    # Create a DataFrame with IDs and their corresponding cluster labels
