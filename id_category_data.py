...
valid_categories = set(valid_categories_df["Category"])  # Assuming 'Category' is the column
    ...
    if filename.endswith(".json"):
        ...
        with open(file_path, "r", encoding="utf-8") as file:
            ...
            for article in data:
                ...
                cats = extract_categories(article.get("categories", []), valid_categories)
                for cat in cats:
                    category_data.append({"ID": article["id"], "Category": cat})
